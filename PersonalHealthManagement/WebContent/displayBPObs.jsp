...
<sql:query var="result"  dataSource="${con}">
    SELECT BP_SYS,BP_DYS,OBS_DATE FROM BP,RECORDS where RECORDS.SSN=${patientSSN} and RECORDS.OBSID=BP.OBS_ID
</sql:query>
        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="user" items="${result.rows}">
                <tr>
                    ...
                    <td><c:out value="${user.BP_SYS}" /></td>
                    <td><c:out value="${user.BP_DYS}" /></td>
