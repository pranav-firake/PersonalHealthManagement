...
/**
 * Servlet implementation class ClearAlertsPatientSpecificByHSServlet
 */
public class ClearAlertsPatientSpecificByHSServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClearAlertsPatientSpecificByHSServlet() {
        super();
